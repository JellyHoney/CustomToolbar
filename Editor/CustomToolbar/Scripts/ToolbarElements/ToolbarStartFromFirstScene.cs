...
internal class ToolbarStartFromFirstScene : BaseToolbarElement
{
    ...
    public override void Init()
    {
        ...
        startFromFirstSceneBtn = new GUIContent((Texture2D)AssetDatabase.LoadAssetAtPath($"{GetPackageRootPath}/Editor/CustomToolbar/Icons/LookDevSingle1@2x.png", typeof(Texture2D)), "Start from first scene");
    }
    ...
    private static void LogPlayModeState(PlayModeStateChange state)
    {
        ...
        {
            string scene = SceneUtility.GetScenePathByBuildIndex(EditorPrefs.GetInt("LastActiveSceneToolbar"));
